...
from models.archs.DynamicConv import *


class Block(nn.Layer): #EBs
    def __init__(self, ):
        super(Block, self).__init__()
        features = 64
        self.conv1 = nn.Sequential(
            nn.Conv2D(in_channels=3, out_channels=features, kernel_size=3, padding=1, groups=1, bias_attr=False),
            nn.ReLU())
        ...
        self.conv4 = nn.Sequential(
            nn.Conv2D(in_channels=features, out_channels=features, kernel_size=3, padding=1, groups=1, bias_attr=False),
            nn.ReLU())
...
class DDYCNNSR(nn.Layer):
    def __init__(self, scale, conv=common.default_conv):
        ...
        self.conv17 = nn.Sequential(
            nn.Conv2D(in_channels=features, out_channels=3, kernel_size=3, padding=1, groups=1, bias_attr=False))
